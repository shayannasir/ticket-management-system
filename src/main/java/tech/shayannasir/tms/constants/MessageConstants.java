...
public class MessageConstants {
    ...
    public static final String NAME_NOT_NULL = "name.not.null";
    public static final String PHONE_NUMBER_NOT_NULL = "phone.not.null";
    public static final String EMAIL_USERNAME_EXIST = "email.username.exist";
    public static final String INVALID_REQUEST = "invalid.request";
    public static final String EMAIL_NOT_NULL = "emailId.not.blank";
    public static final String USERNAME_PASSWORD_NOT_NULL = "username.password.not.null";
